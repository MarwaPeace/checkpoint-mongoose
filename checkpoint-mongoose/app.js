...
async function main() {
    ...
    await mongoose.connect('mongodb+srv://marwa:marwa@favouritefood.penucox.mongodb.net/?retryWrites=true&w=majority');
...
//List.deleteOne({name:"Dahmen"}).then()
